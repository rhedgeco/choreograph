use super::{BranchExt, Entry, GraphExecutor, JoinExt};
...
fn simple_join() {
    ...
    let root_task = Entry::new(|v: u32| v + 100);
...
//     // build a simple graph root
//     let root_task = Entry::new(|v: u32| v);

//     // create an always task that counts up every time its called
//     let always_task = root_task.always(|v| {
//         static COUNTER: AtomicU32 = AtomicU32::new(1);
//         v + COUNTER.fetch_add(1, Ordering::Relaxed)
//     });

//     // branch off the always task 3 times
//     let branch1 = always_task.branch(|v| v);
//     let branch2 = always_task.branch(|v| v);
//     let branch3 = always_task.branch(|v| v);

//     // join all three branches
//     let join1 = branch1.join(branch2, |(v1, v2)| v1 + v2);
